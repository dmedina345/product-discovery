...
One row per AskQuestion answer — this is the authoritative record cited by requirements Won't Have / Resolved decisions.

| # | Date | Question (M-id + topic) | Options offered | PO answer | Carried into |
| - | ---- | ----------------------- | --------------- | --------- | ------------ |
| 1 |      |                         |                 |           |              |
