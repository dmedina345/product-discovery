...
**Full doc:** [letsmake-product-workflow.md](./letsmake-product-workflow.md) · **Skills:** [`skills/README.md`](../../README.md)
...
`desk` · `comparable` · `figma` · `video` (YouTube → `scripts/youtube-transcript.sh`) · `technical` · `prototype`
